...
export class Floor {
    ...
    public floorSize: { x: number; y: number } = {x: 10, y: 10};
    ...
    createFloor(){
        ...
        let xmin = (0-this.floorSize.x/2)-0.5;
        let xmax = (this.floorSize.x/2)+0.5;
        let zmin = (0-this.floorSize.y/2)-0.5;
        let zmax = (this.floorSize.y/2)+0.5;
